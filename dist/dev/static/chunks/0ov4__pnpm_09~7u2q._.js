...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/modals/fullscreen/data-hooks.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/modals/fullscreen/fullscreen-scss.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var styleDataHash = "e6e35475";
const injectCss = ()=>{
    var css = `.cAUsA [data-hook^=gallery-media-]{display:block;inline-size:100%;overflow:hidden;position:relative}.cAUsA [data-hook^=gallery-media-]>img,.cAUsA [data-hook^=gallery-media-]>video{block-size:100%;display:block;inline-size:100%;object-position:center}.cAUsA [data-hook^=gallery-media-]{align-items:center;display:flex;justify-content:center}.cAUsA [data-hook^=gallery-media-]>img,.cAUsA [data-hook^=gallery-media-]>video{block-size:auto;inline-size:auto;margin:auto;max-block-size:100%;max-inline-size:100%;object-fit:contain}.cAUsA [data-hook=gallery-media-failure]{background:#e5e5e5;min-block-size:1px;min-inline-size:1px}.cAUsA [data-hook=gallery-video-play]{appearance:none;background:transparent;border:0;cursor:pointer;inline-size:100%;inset:0;padding:0;position:absolute}.cAUsA [data-hook=gallery-video-play]:focus-visible{outline:2px solid #3899ec;outline-offset:-2px}.cAUsA [data-hook=gallery-video-play]>span{block-size:0;border-block:12px solid transparent;border-inline-start:18px solid #fff;filter:drop-shadow(0 1px 2px rgba(0,0,0,.6));inline-size:0;inset-block-start:50%;inset-inline-start:50%;position:absolute;transform:translate(-40%,-50%)}.re2rC{align-items:center;appearance:none;background:transparent;block-size:39px;border:0;border-radius:0;color:#000;cursor:pointer;display:inline-flex;inline-size:23px;justify-content:center;padding:0;transition:opacity .12s ease}.re2rC:disabled,[aria-disabled=true].re2rC:not(:focus-visible){pointer-events:none;visibility:hidden}.re2rC:focus-visible{outline:2px solid #3899ec;outline-offset:2px}@media (prefers-reduced-motion:reduce){.re2rC{transition:none}}.re2rC{inset-block-start:50%;position:absolute;transform:translateY(-50%)}.re2rC svg{block-size:39px;display:block;inline-size:23px;fill:currentColor;filter:drop-shadow(0 1px .15px #b2b2b2)}.tEtKz,.ysMjh{background:#fff;box-sizing:border-box;display:grid;grid-template-rows:minmax(0,1fr) auto;height:100dvh;inset:0;position:fixed;width:100vw;z-index:100001}.tEtKz{padding-block:70px 20px}@media only screen and (max-width:640px){.tEtKz{padding-block-start:40px}}._6ffuq,.ysMjh{padding:0}._6ffuq{background:transparent;border:hidden;border-radius:4px;box-sizing:border-box;color:#000;cursor:pointer;height:fit-content;position:fixed;right:17px;top:10px;width:fit-content;z-index:1001}@media only screen and (max-width:640px){._6ffuq{right:20px;top:5px}._6ffuq>svg{height:30px;width:30px}}._6ffuq:focus-visible{outline:5px auto Highlight!important;outline:5px auto -webkit-focus-ring-color!important}.c09tI{background:transparent;border:hidden;border-radius:4px;box-sizing:border-box;color:#000;cursor:pointer;height:fit-content;left:22px;padding:0;position:fixed;top:10px;width:fit-content;z-index:1001}.c09tI:focus-visible{outline:5px auto Highlight!important;outline:5px auto -webkit-focus-ring-color!important}.qpg9s{font-size:14px;line-height:20px;text-align:center;white-space:normal}.s5bnI{box-sizing:border-box;display:flex;justify-content:center;min-height:60px;padding:16px 20px;width:100%}.uV6--{height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px;clip:rect(0,0,0,0);border:0;white-space:nowrap}.rlZ9v{min-height:0;position:relative;--ricos-internal-gallery-arrow-inset:20px}.LL24i,.rlZ9v{height:100%;min-width:0}.LL24i{overflow-x:auto;overflow-y:hidden;scroll-snap-type:inline mandatory;scrollbar-width:none}.LL24i::-webkit-scrollbar{display:none}.TAr1m{display:flex;height:100%;list-style:none;margin:0;padding:0}.cAUsA{flex:0 0 100%;height:100%;min-width:0;scroll-snap-align:start;scroll-snap-stop:always;width:100%}.cAUsA [data-hook^=gallery-media-]{background:transparent;height:100%}.re2rC{color:inherit;z-index:1}.re2rC[data-hook=gallery-navigation-previous]{inset-inline-start:var(--ricos-internal-gallery-arrow-inset,12px)}.re2rC[data-hook=gallery-navigation-previous] svg{transform:scaleX(-1)}.re2rC[data-hook=gallery-navigation-next]{inset-inline-end:var(--ricos-internal-gallery-arrow-inset,12px)}`;
...
var fullscreen_default = {
    "slide": "cAUsA",
    "arrow": "re2rC",
    "fullscreen_mode": "ysMjh",
    "expand_mode": "tEtKz",
    "close": "_6ffuq",
    "expand_button": "c09tI",
    "title": "qpg9s",
    "info_container": "s5bnI",
    "visuallyHidden": "uV6--",
    "carousel": "rlZ9v",
    "viewport": "LL24i",
    "track": "TAr1m"
...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/modals/fullscreen/fullscreen-carousel.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/modals/fullscreen/fullscreen-modal.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=0ov4__pnpm_09~7u2q._.js.map