...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/_shared/node-animation/get-node-animation.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/_shared/node-animation/has-entrance-animation.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/ContentViewer/pointer-animation-manager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "createPointerAnimationManager",
    ()=>createPointerAnimationManager
]);
...
const createPointerAnimationManager = ()=>{
    const byTarget = /* @__PURE__ */ new Map();
    const onScreen = /* @__PURE__ */ new Set();
    let lastEvent = null;
    let frame = 0;
    let listening = false;
    const observer = typeof IntersectionObserver === "undefined" ? null : new IntersectionObserver((entries)=>{
        for (const entry of entries){
            const instance = byTarget.get(entry.target);
            if (!instance) {
                continue;
            }
            if (entry.isIntersecting) {
                onScreen.add(instance);
            } else if (onScreen.delete(instance)) {
                instance.progress(CENTER);
            }
        }
    });
    const applyFrame = ()=>{
        ...
        const measured = Array.from(onScreen, (instance)=>{
            const rect = instance.target.getBoundingClientRect();
            return {
                instance,
                x: clamp01(0.5 + (event.clientX - (rect.left + rect.width / 2)) / window.innerWidth),
                y: clamp01(0.5 + (event.clientY - (rect.top + rect.height / 2)) / window.innerHeight)
            };
        });
        measured.forEach(({ instance, x, y })=>instance.progress({
                x,
                y
            }));
    };
    ...
    return {
        register: (instance)=>{
            byTarget.set(instance.target, instance);
            onScreen.add(instance);
            observer?.observe(instance.target);
            if (!listening) {
                listening = true;
        ...
        dispose: ()=>{
            ...
            observer?.disconnect();
            byTarget.forEach((instance)=>instance.cancel());
            byTarget.clear();
            onScreen.clear();
            lastEvent = null;
        }
...
"[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/ContentViewer/node-animations-runtime.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$_shared$2f$node$2d$animation$2f$motion$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/_shared/node-animation/motion-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$ricos$2d$viewer$2d$next$2f$ContentViewer$2f$pointer$2d$animation$2d$manager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Github/ptsl-2026/node_modules/.pnpm/@wix+ricos@11.11.2_@babel+c_967d2a9d5f0144a013b2d9a49aefa898/node_modules/@wix/ricos/dist/es/ricos-viewer-next/ContentViewer/pointer-animation-manager.js [app-client] (ecmascript)");
;
;
;
;
const hasLoopAnimation = (animation)=>animation.type === "VIEW" && Boolean(animation.loop?.effect);
...
const hasEntered = (entry)=>{
    if (entry.intersectionRatio >= ENTRANCE_THRESHOLD) {
        return true;
    }
    const rootHeight = entry.rootBounds?.height ?? window.innerHeight;
    return entry.boundingClientRect.height > rootHeight / ENTRANCE_THRESHOLD;
};
const reveal = (element)=>element.setAttribute("data-ricos-entered", "");
const entranceFinishedByElement = /* @__PURE__ */ new WeakMap();
const collectAnimations = (nodes, byNodeId)=>nodes.forEach((node)=>{
        ...
        if (animation && node.id) {
            byNodeId.set(node.id, animation);
        }
        collectAnimations(node.nodes ?? [], byNodeId);
    });
const initNodeAnimations = (root, nodes)=>{
    const byNodeId = /* @__PURE__ */ new Map();
    collectAnimations(nodes, byNodeId);
    const elements = Array.from(root.querySelectorAll("[data-ricos-animation]"));
    if (window.matchMedia?.("(prefers-reduced-motion: reduce)").matches) {
        elements.forEach(reveal);
        return ()=>{};
    }
    const liveLoops = /* @__PURE__ */ new Set();
    let pointerManager = null;
    let disposed = false;
    const playWhileLive = (group, onPlay)=>group.ready.then(()=>{
            if (!disposed) {
                onPlay?.();
                group.play().catch(()=>{});
            }
        }).catch(()=>{});
    const startLoop = (element, animation)=>{
        if (disposed) {
            return;
        }
        const group = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$_shared$2f$node$2d$animation$2f$motion$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoopAnimation"])(element, animation);
        if (!group) {
            return;
        }
        liveLoops.add(group);
    ...
    const observer = new IntersectionObserver((entries)=>{
        for (const entry of entries){
            if (!entry.isIntersecting || !hasEntered(entry)) {
                continue;
            }
            const element = entry.target;
            observer.unobserve(element);
            const animation = byNodeId.get(element.dataset.ricosAnimation ?? "");
            if (!animation) {
                reveal(element);
                continue;
            }
            const entranceGroup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$_shared$2f$node$2d$animation$2f$has$2d$entrance$2d$animation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasEntranceAnimation"])(animation) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$_shared$2f$node$2d$animation$2f$motion$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEntranceAnimation"])(element, animation) : null;
            if (!entranceGroup) {
                reveal(element);
                if (hasLoopAnimation(animation)) {
                    startLoop(element, animation);
                }
                continue;
            }
            const entranceFinished = entranceGroup.finished;
            entranceFinished.then(()=>{
                if (hasLoopAnimation(animation)) {
                    startLoop(element, animation);
                }
            }, ()=>{});
            playWhileLive(entranceGroup, ()=>entranceFinishedByElement.set(element, entranceFinished));
            entranceGroup.ready.then(()=>reveal(element)).catch(()=>reveal(element));
        }
    }, {
    ...
    elements.forEach((element)=>{
        const animation = byNodeId.get(element.dataset.ricosAnimation ?? "");
        if (animation?.type === "POINTER") {
            reveal(element);
            const instance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$_shared$2f$node$2d$animation$2f$motion$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPointerAnimation"])(element, animation);
            if (instance) {
                pointerManager ??= (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Github$2f$ptsl$2d$2026$2f$node_modules$2f2e$pnpm$2f40$wix$2b$ricos$40$11$2e$11$2e$2_$40$babel$2b$c_967d2a9d5f0144a013b2d9a49aefa898$2f$node_modules$2f40$wix$2f$ricos$2f$dist$2f$es$2f$ricos$2d$viewer$2d$next$2f$ContentViewer$2f$pointer$2d$animation$2d$manager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPointerAnimationManager"])();
                pointerManager.register(instance);
            }
            return;
        }
        if (element.hasAttribute("data-ricos-entered")) {
            if (animation && hasLoopAnimation(animation)) {
                const entranceFinished = entranceFinishedByElement.get(element);
                if (entranceFinished) {
                    entranceFinished.then(()=>startLoop(element, animation), ()=>{});
                } else {
                    startLoop(element, animation);
                }
            }
    ...
    return ()=>{
        disposed = true;
        observer.disconnect();
        liveLoops.forEach((group)=>group.cancel());
...
//# sourceMappingURL=0ov4__pnpm_0p7dms1._.js.map